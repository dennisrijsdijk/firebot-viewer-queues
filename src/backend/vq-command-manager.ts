            ...
            definition: {
                ...
                options: {
                    ...
                    joinCommandAlreadyJoinedTemplate: {
                        ...
                        description: "How the !join command should respond when the user is already in the queue.",
                    ...
                    joinCommandAlreadyJoinedRandomTemplate: {
                        ...
                        description: "How the !join command should respond when the user is already in the queue, and the queue is random.",
                    ...
                    joinCommandClosedTemplate: {
                        ...
                        description: "How the !join command should respond when the queue is closed.",
                    ...
                    joinCommandJoinedTemplate: {
                        ...
                        description: "How the !join command should respond when the user successfully joins the queue, and the queue is not random.",
                        tip: "Variables: {username}, {queueName}, {queuePosition}, {queuePeopleAhead}, {queueLength}",
                    ...
                    joinCommandJoinedRandomTemplate: {
                        ...
                        description: "How the !join command should respond when the user successfully joins the queue, and the queue is random.",
                        tip: "Variables: {username}, {queueName}, {queueLength}",
                    ...
                    positionCommandNotJoinedTemplate: {
                        ...
                        description: "How the !position command should respond when the user is not in the queue.",
                        tip: "Variables: {username}, {queueName}, {queueLength}, {queueStatus}",
                    ...
                    positionCommandPositionTemplate: {
                        ...
                        description: "How the !position command should respond when reporting the user's position in the queue.",
                        tip: "Variables: {username}, {queueName}, {queuePosition}, {queuePeopleAhead}, {queueLength}, {queueStatus}",
                    ...
                    positionCommandIsRandomTemplate: {
                        ...
                        description: "How the !position command should respond when the queue is random.",
                        tip: "Variables: {username}, {queueName}, {queueLength}, {queueStatus}",
                    ...
                    leaveCommandNotJoinedTemplate: {
                        ...
                        description: "How the !leave command should respond when the user is not in the queue.",
                        tip: "Variables: {username}, {queueName}",
                        default: "You are not currently in the queue, {username}.",
                        useTextArea: true,
                    },
                    leaveCommandLeftTemplate: {
                        ...
                        description: "How the !leave command should respond when the user successfully leaves the queue.",
                        tip: "Variables: {username}, {queueName}, {queueLength}",
                    ...
                    clearCommandClearedTemplate: {
                        ...
                        description: "How the !clear command should respond when the queue is cleared.",
                    ...
                    pickCommandPickedTemplate: {
                        ...
                        description: "How the !pick command should respond when a viewer is picked from the queue.",
                    ...
                    pickCommandNoViewersTemplate: {
                        ...
                        description: "How the !pick command should respond when there are no viewers in the queue.",
                        tip: "Variables: {queueName}",
                    ...
                    pickCommandAutoSplitCount: {
                        ...
                        description: "If picking multiple viewers, how many viewers to attempt to put in each message.",
                        default: 3,
                    },
                    ...
                    openCommandOpenedTemplate: {
                        ...
                        description: "How the !open command should respond when the queue is opened.",
                        tip: "Variables: {queueName}",
                    ...
                    openCommandAlreadyOpenTemplate: {
                        ...
                        description: "How the !open command should respond when the queue is already open.",
                        tip: "Variables: {queueName}",
                    ...
                    closeCommandClosedTemplate: {
                        ...
                        description: "How the !close command should respond when the queue is closed.",
                        tip: "Variables: {queueName}",
                    ...
                    closeCommandAlreadyClosedTemplate: {
                        ...
                        description: "How the !close command should respond when the queue is already closed.",
                        tip: "Variables: {queueName}",
